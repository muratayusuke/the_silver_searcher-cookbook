...
describe "the_silver_searcher::default" do
  ...
  it "downloads and compiles the_silver_searcher" do
    ...
    # NOTE: the default action on bash[install the_silver_searcher]
    #       is :nothing; hence chefspec will not run it, and we spec
    #       as such
    expect(chef_run).not_to run_bash("install the_silver_searcher")
  end
end
